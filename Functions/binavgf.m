...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% usage: [meanx meand bins]=binavg(x,d,binsize,dist)    mean x = cholrophyl
%meand = profondeur   binsize : 50cm  dist = Distance sur lequel le
%binaverage s'applique 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% dist = distance to be used to create the number of bins

% Coded by Alex Forrest
% Added standard deviation output A. Hamilton 2014

% Originally coded by BL and DJP but a new interpolation function added.

function [meanx,meand,stdx, bins]=binavgf(x,d,binsize,dist)
